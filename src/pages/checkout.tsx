...
export default function Checkout() {
    ...
    const products: Product[] = [
        {
            ...
            price: 120,
            thumbnail: "https://images.unsplash.com/flagged/photo-1556637640-2c80d3201be8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8c25lYWtlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60",
            brand: "nike",
        },
        {
            id: 2,
    ...
    useEffect(() => {
        setSubtotal(
            products.reduce((acc, elem) => acc + elem.price, 0)
        )
            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                <div className="px-4 pt-8">
                    ...
                    <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
                        ...
                        </div> */}
                        {
                            products.length > 0 ? (
                                ...
                                <div className="flex flex-col rounded-lg bg-white sm:flex-row">
                                    <div className="flex w-full flex-col px-4 py-4">
                                        <span className="font-semibold">no items in the Cart</span>
                                    </div>
                                </div>
                            )
                        }
                    ...
                    <form className="mt-5 grid gap-6">
                        <div className="relative">
                            <input className="peer hidden" id="radio_1" type="radio" name="radio" defaultChecked onChange={() => handleDelivery(8)} />
                        ...
                        <div className="relative">
                            <input className="peer hidden" id="radio_2" type="radio" name="radio" onChange={() => handleDelivery(20)} />
                            <span className="peer-checked:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
