            ...
            <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="xl:col-span-1">
                        ...
                        <p className="mt-8 text-base text-gray-500">Making the world a better place through constructing elegant hierarchies.</p>
                    ...
                    <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h4 className="text-sm font-semibold uppercase tracking-wider text-gray-400">Solutions</h4>
                                <ul className="mt-4">
                                    <li>
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            ...
                            <div className="mt-12 md:mt-0">
                                ...
                                <ul className="mt-4">
                                    ...
                                    <li className="mt-4">
                                        <Link to="login" className="text-base text-gray-500 hover:text-gray-900">login</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
